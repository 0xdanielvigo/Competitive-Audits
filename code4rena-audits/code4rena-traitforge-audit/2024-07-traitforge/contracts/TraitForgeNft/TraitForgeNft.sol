  ...
  Pausable
{
  ...
  //@audit-informational, this variable should be constant
  ...
  //@audit-medium, there is not an effective maximum generation, nfts can be minted to infinity.
  ...
  //@audit-informational, no 0 address checks on '_nukeFundAddress'
...
//@audit-informational, missing natspac
  function _mintInternal(address to, uint256 mintPrice) internal {
    ...
    //@audit-informational, it is better to use safeMint
    _mint(to, newItemId);
...
//@audit-informational, missing natspac
  function _incrementGeneration() private {
    ...
    //@audit-medium/high, this contract is not the owner of entropyGenerator, and for this reason 
      //this call will fail
  ...
  //@audit-q, is there something that can break this function in the 'nukeFundAddress' receive function?
