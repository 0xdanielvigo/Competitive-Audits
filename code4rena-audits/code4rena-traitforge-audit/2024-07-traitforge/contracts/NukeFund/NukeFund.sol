...
//if aidrop is not started 
  ...
  //@audit-informational, no 0 address checks on '_traitForgeNft'
  ...
  //@audit-high, this function does not return the correct age for minted nfts
  //'performanceFactor' can be 0 if token entropy is a value not divisible by 10
