...
contract EntityForging is IEntityForging, ReentrancyGuard, Ownable, Pausable {
  //@audit-informational, this variable should be setted as immutable
  ...
  //@audit-informational, no 0 address check on '_nukeFundAddress'
  ...
  function forgeWithListed(
    ...
    //@audit, what happens to funds if msg.value is higher than 'forgingFee'
