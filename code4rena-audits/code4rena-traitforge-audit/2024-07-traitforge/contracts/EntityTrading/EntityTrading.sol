...
//@audit-informational, this file has been imported but never used
...
contract EntityTrading is IEntityTrading, ReentrancyGuard, Ownable, Pausable {
  //@audit-informational, this variable shold be marked as immutable 
  ...
  //@audit-informtional, no check on 0 address
...
//@audit-informational, consider useing safeTransferFrom
  ...
  function cancelListing(uint256 tokenId) public whenNotPaused nonReentrant {
    ...
    require(
      ...
      //@audit-informational, spelling is wrong
