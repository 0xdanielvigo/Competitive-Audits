...
//run this test --> sudo forge test --match-path test/Foundry/TraitForgeNftTest.t.sol -vvv --gas-limit 200000000000
...
vm.startPrank(owner); 
bytes32 leave1 = keccak256(abi.encode("Ciao"));
bytes32 leave2 = keccak256(abi.encode("Mamma")); 
bytes32 leave3 = keccak256(abi.encode("Come")); 
bytes32 leave4 = keccak256(abi.encode("Stai?"));  
